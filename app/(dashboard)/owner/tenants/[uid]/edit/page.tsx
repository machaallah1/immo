// app/dashboard/owner/tenants/[id]/edit/page.tsx
'use client';
...
export default function EditTenantPage() {
  ...
  const { fetchUserProfile, updateUser, canManageTenants } = useUserManagement();
    ...
    try {
      ...
      if (tenantData) {
        setFormData({
          ...
          firstName: tenantData.tenant?.firstName || '',
          lastName: tenantData.tenant?.lastName || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      form.append('role', 'TENANT'); // Toujours TENANT pour un locataire

      const result = await updateUser(tenantId, form);
          ...
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-gray-500 mt-2">
                Vous n'avez pas les permissions nécessaires pour modifier les locataires.
              </p>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Modifiez les informations de {tenant.tenant?.firstName} {tenant.tenant?.lastName}
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <Button type="submit" disabled={loading}>
                ...
                {loading ? 'Modification...' : 'Modifier le locataire'}
              </Button>
